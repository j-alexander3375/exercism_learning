...
namespace estate_executor {
    int assemble_account_number(int secret_modifier) {
        ...
        int number = garcia::bank_number_part(secret_modifier);
        number += khan::bank_number_part(secret_modifier);
        number += zhang::bank_number_part(secret_modifier);
    ...
    int assemble_code() {
        ...
        int red = khan::red::code_fragment() + garcia::red::code_fragment() + zhang::red::code_fragment();
        int blue = khan::blue::code_fragment() + garcia::blue::code_fragment() + zhang::blue::code_fragment();
